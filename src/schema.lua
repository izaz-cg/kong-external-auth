    return {
      no_consumer = true,
      fields = {
        url = { required = true, type = "url", default = "http://payment-user-uat.service.uat.svc.cluster.local:8000" },
        path = { default = "/payment-user/verify_token", type = "string" },
        ...
        token_header = { default = "Authorization", type = "string" }
      }
    }
